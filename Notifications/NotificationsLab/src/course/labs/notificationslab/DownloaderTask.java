...
public class DownloaderTask extends AsyncTask<String, Void, String[]> {
	...
	protected void onPostExecute(String[] result) {
		...
		Log.i("DANITXU", "Refreshing Main Frame");
	...
	private void notify(final boolean success) {
		...
		//restartMainActivtyIntent.putExtra("TEST", "TEST");
		...
		mApplicationContext.sendOrderedBroadcast(
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						log("RESULTCODE =>" + this.getResultCode());
						log("Activity.RESULT_OK =>" + Activity.RESULT_OK);
